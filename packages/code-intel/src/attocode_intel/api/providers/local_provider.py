...
from attocode_intel.api.deps import ensure_branch_supported
...
class LocalAnalysisProvider:
    ...
    async def dependency_graph(
        ...
        from attocode_intel.api.models import DependencyGraphEdge, DependencyGraphNode
...
class LocalSearchProvider:
    ...
    async def semantic_search(
        ...
        manifest_hash = ""
        try:
            from attocode_intel.tools.pin_store import (
