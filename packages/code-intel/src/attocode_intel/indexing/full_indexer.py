...
from attocode_intel.indexing.parser import detect_language, extract_imports, extract_references, extract_symbols
...
class FullIndexer:
    ...
    async def index(
        ...
        from attocode_intel.db.models import SymbolReference
