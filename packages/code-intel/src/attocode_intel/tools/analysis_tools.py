...
def _louvain_communities(
    ...
    from attocode_intel.community import louvain_communities
...
def repo_map_ranked(
    ...
    from attocode_intel.repo_ranker import format_repo_map, rank_repo_files
...
def bug_scan(base_branch: str = "main", min_confidence: float = 0.5) -> str:
    ...
    from attocode_intel.bug_finder import scan_diff
