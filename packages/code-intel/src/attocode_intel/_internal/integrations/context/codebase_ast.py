...
def parse_file(file_path: str, content: str | None = None) -> FileAST:
    ...
    try:
        from attocode_intel._internal.integrations.context.ts_parser import ts_parse_file
    ...
    try:
        from attocode_intel._internal.integrations.context.ts_parser import ts_parse_file_generic
    ...
    try:
        from attocode_intel._internal.integrations.context.ts_parser import ctags_parse_file
