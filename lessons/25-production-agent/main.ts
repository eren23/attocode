/**
 * Lesson 25: Production Agent - A Real Usable Coding Agent
 *
 * This is the culmination of all lessons - a fully-featured coding agent
 * you can actually use for development tasks.
 *
 * Features integrated:
 ...
 * - Session persistence
 *
 * Run: npx tsx 25-production-agent/main.ts
 */
...
import { createStandardRegistry } from '../09-complete-agent/tools.js';
...
async function startProductionREPL(
  ...
  console.log(`
${c('╔════════════════════════════════════════════════════════════════╗', 'cyan')}
${c('║          LESSON 25: PRODUCTION AGENT (CAPSTONE)                ║', 'cyan')}
${c('║                                                                 ║', 'cyan')}
...
function showHelp(): void {
  console.log(`
${c('LESSON 25: PRODUCTION AGENT (CAPSTONE)', 'bold')}
...
${c('USAGE:', 'bold')}
  npx tsx 25-production-agent/main.ts [OPTIONS] [TASK]
...
${c('EXAMPLES:', 'bold')}
  # Interactive mode
  npx tsx 25-production-agent/main.ts

  # Single task
  npx tsx 25-production-agent/main.ts "List all TypeScript files"

  # With specific model
  npx tsx 25-production-agent/main.ts -m anthropic/claude-sonnet-4 "Explain this code"
