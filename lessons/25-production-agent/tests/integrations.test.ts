...
import {
  ...
  type Finding,
  type FindingType,
} from '../integrations/shared-blackboard.js';
import {
  SmartDecomposer,
  createSmartDecomposer,
  type SmartSubtask,
} from '../integrations/smart-decomposer.js';
import {
  ResultSynthesizer,
  createResultSynthesizer,
  type AgentOutput,
} from '../integrations/result-synthesizer.js';
import {
  CodebaseContextManager,
  createCodebaseContext,
} from '../integrations/codebase-context.js';
