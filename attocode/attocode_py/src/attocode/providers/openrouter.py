...
class OpenRouterProvider:
    ...
    def __init__(
        ...
        *,
        ...
        if not self._api_key:
            raise ProviderError("OPENROUTER_API_KEY not set", provider="openrouter", retryable=False)
        self._model = model
    ...
    def _create_client(self) -> httpx.AsyncClient:
        ...
        return httpx.AsyncClient(
            ...
            headers={
                ...
                "HTTP-Referer": f"https://github.com/{self._app_name}",
    ...
    async def chat(
        ...
        try:
            ...
            raise ProviderError(
                f"OpenRouter API error {status}: {e.response.text[:500]}",
