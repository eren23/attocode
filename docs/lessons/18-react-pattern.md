---
title: "Lesson 18: ReAct Pattern (Reasoning + Acting)"
---

!!! info "Source Code"
    The runnable TypeScript source for this lesson is in
    [`lessons/18-react-pattern/`](https://github.com/eren23/attocode/tree/main/lessons/18-react-pattern/)
...
agent.on((event) => {
  switch (event.type) {
    ...
    case 'action':
      ...
      break;
    case 'observation':
      console.log(`Observed: ${event.observation.slice(0, 50)}...`);
      break;
    case 'final_answer':
